    ...
    <div className="flex flex-col items-center gap-5">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <motion.button
          ...
          className="relative rounded-full flex items-center justify-center cursor-pointer z-10 disabled:cursor-not-allowed"
        >
          <AnimatePresence mode="wait">
            {isProcessing ? (
              ...
              <motion.div key="mute"
                animate={{ opacity: [1, 0.55, 1] }} transition={{ duration: 1, repeat: Infinity }}>
